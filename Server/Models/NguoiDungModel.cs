...
namespace Server.Models
{
    public class NguoiDungModel
    {
        ...
        public NguoiDungModel(int id, string? tenDangNhap, string? matKhau, string? hoTen, DateOnly? ngaySinh, string? email, string? soDienThoai, string? diaChi, string? hinhanh, int vaiTro, DateTime created)
        {
            Id = id;
